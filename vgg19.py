...
train_dir=os.path.join('DataSets/Images/dataset','train')
validation_dir=os.path.join('DataSets/Images/dataset','validate')
test_dir=os.path.join('DataSets/Images/dataset','test')
